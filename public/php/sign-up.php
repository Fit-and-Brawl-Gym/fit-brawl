...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["signup"])) {
    ...
    if ($insertQuery->execute()) {
        ...
        try {
            ...
            $_SESSION["register_error"] =
                "Account created but verification email could not be sent. Error: " .
                $mail->ErrorInfo;
            header("Location: sign-up.php");
            exit();
        }
    ...
    <section class="signup-hero">
        <div class="hero-content">
            ...
            <div class="hero-title-flex">
                <p>ONE BOLD STEP</p>
                <p style="color: #d5ba2b">CREATE ACCOUNT </p>
            </div>
                ...
                <div id="messageContainer" class="message-container">
                    <?php if (isset($_SESSION["register_error"])): ?>
                        <div class="error-message-box" id="errorMessageBox">
                            ...
                            <div class="message-text"><?= $_SESSION[
                                "register_error"
                            ] ?></div>
                        </div>
                ...
                <div class="input-container">
                    ...
                    <div class="password-requirements-modal" id="passwordRequirementsModal">
                        <div class="password-requirements-header">
                            ...
                            <button type="button" class="mobile-close-btn" id="closePwdRequirements"
    ...
    <div class="terms-modal-container">
        ...
        <div class="terms-modal-body">
            <div class="terms-sidebar">
                ...
                <div class="terms-mobile-nav" data-active="#use-of-website">
                    ...
                    <ul class="terms-dropdown-list" hidden>
                        ...
                        <li><button type="button" data-target="#booking-scheduling">2. Booking and Scheduling</button>
                        </li>
                        <li><button type="button" data-target="#payments-fees">3. Payments and Fees</button></li>
                        <li><button type="button" data-target="#cancellations-refunds">4. Cancellations and
                                Refunds</button></li>
                        <li><button type="button" data-target="#health-safety">5. Health and Safety</button></li>
                        <li><button type="button" data-target="#memberships">6. Memberships and Subscriptions</button>
                        </li>
                        <li><button type="button" data-target="#intellectual-property">7. Intellectual Property</button>
                        </li>
                        <li><button type="button" data-target="#limitation-liability">8. Limitation of
                                Liability</button></li>
            ...
            <div class="terms-content">
                ...
                <p class="terms-intro">Welcome to Fit and Brawl! These Terms and Conditions ("Terms") govern your use of
                    our website, [Wala pang website link], and all related services offered by Fit and Brawl. By
                    accessing or using our website, scheduling sessions, or purchasing services, you agree to comply
                    with these Terms.</p>

                <h3 id="use-of-website">1. Use of Our Website</h3>
                <ul>
                    <li>You must be at least 18 years old (or have parental consent) to create an account and use our
                        online services.</li>
                    <li>You agree to provide accurate, complete, and current information when creating an account or
                        booking sessions.</li>
                ...
                <ul>
                    ...
                    <li>You agree to arrive on time for your scheduled sessions. Late arrivals may result in reduced
                        session time.</li>
                </ul>
                ...
                <ul>
                    ...
                    <li>Late cancellations or "no-shows" may result in a cancellation fee or forfeiture of the session.
                    </li>
                ...
                <ul>
                    <li>By using our services, you confirm that you are physically fit and have consulted a medical
                        professional if needed.</li>
                    <li>You agree to follow all gym rules, safety guidelines, and instructions from our trainers.</li>
                    <li>We are not responsible for any injuries, accidents, or health issues that occur during
                        participation in our programs.</li>
                </ul>

                <h3 id="memberships">6. Memberships and Subscriptions</h3>
                <ul>
                    <li>If you purchase a membership, you agree to the terms of your selected plan (duration, renewal,
                        and cancellation policies).</li>
                ...
                <ul>
                    <li>All content on this website (text, images, logos, videos, etc.) is the property of Fit and Brawl
                        and is protected by copyright law.</li>
                ...
                <ul>
                    <li>Fit and Brawl is not liable for any indirect, incidental, or consequential damages arising from
                        your use of our website or services.</li>
                ...
                <ul>
                    <li>We respect your privacy and will not share your data with third parties except as required by
                        law.</li>
                </ul>
                ...
                <ul>
                    ...
                    <li>Continued use of our website or services after such changes means you accept the revised Terms.
                    </li>
                </ul>
            </div>
        </div>
