...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($name) || empty($email) || empty($phone) || empty($specialization)) {
        ...
        if ($result->num_rows > 0) {
            ...
            if (empty($error)) {
                // Insert trainer
                $insert_query = "INSERT INTO trainers (name, email, phone, specialization, bio, photo, emergency_contact_name, emergency_contact_phone, status) 
                                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
                ...
                if ($stmt->execute()) {
                    ...
                    $details = "New trainer added: $name ($specialization)";
                ...
                <div class="form-section">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="tel" id="phone" name="phone" placeholder="+63-917-XXX-XXXX" required value="<?= isset($_POST['phone']) ? htmlspecialchars($_POST['phone']) : '' ?>">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="bio" name="bio" rows="4" placeholder="Brief description of the trainer's experience and expertise..."><?= isset($_POST['bio']) ? htmlspecialchars($_POST['bio']) : '' ?></textarea>
                ...
                <div class="form-section">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="emergency_contact_name" name="emergency_contact_name" value="<?= isset($_POST['emergency_contact_name']) ? htmlspecialchars($_POST['emergency_contact_name']) : '' ?>">
                        </div>
                        
                        <div class="form-group">
                            <label for="emergency_contact_phone">Emergency Contact Phone</label>
                            <input type="tel" id="emergency_contact_phone" name="emergency_contact_phone" placeholder="+63-917-XXX-XXXX" value="<?= isset($_POST['emergency_contact_phone']) ? htmlspecialchars($_POST['emergency_contact_phone']) : '' ?>">
                        </div>
                    </div>
                </div>
