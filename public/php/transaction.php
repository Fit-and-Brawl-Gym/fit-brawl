...
<head>
    ...
    <title>Complete Transaction - FitXBrawl</title>
...
<body>
            ...
            <div class="transaction-box">
                <form id="subscriptionForm" class="subscription-form">
                                ...
                                <label class="billing-option">
                                    ...
                                    <div class="billing-label">
                                        ...
                                        <div class="billing-info">
                                            ...
                                            <div class="billing-price"><?php echo number_format($monthlyPrice); ?>PHP/month</div>
                                        </div>
                                    </div>
                                </label>
                                        ...
                                        <div class="billing-info">
                                            ...
                                            <div class="billing-price">
                                                <?php if ($billing === 'yearly' && $selectedPlan['has_discount']): ?>
                                                    <span class="original-price"><?php echo number_format($monthlyPrice * 12); ?>PHP</span>
                                                <?php endif; ?>
                    ...
                    <p class="terms-notice">
                        By confirming your membership, you allow this website to charge your qcash for this payment and future payments in accordance with its terms. You can always cancel your membership.
                    </p>
                </form>
            </div>
        </div>
    ...
    <div class="receipt-modal" id="receiptModal">
        ...
        <div class="modal-body">
            <p class="modal-instruction">Please upload a screenshot or photo of your payment receipt to complete your subscription.</p>
